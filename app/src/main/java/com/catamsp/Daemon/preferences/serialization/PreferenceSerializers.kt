...
package com.catamsp.Daemon.preferences.serialization
...
@Suppress("UNCHECKED_CAST")
class MapStringStringPreferenceSerializer :
    PreferenceSerializer<java.util.HashMap<String, String>?, java.util.Set<java.lang.String>?> {

    @Serializable
    private class MapEntry(val key: String, val value: String)

    @Throws(PreferenceSerializationException::class)
    override fun serialize(value: java.util.HashMap<String, String>?): java.util.Set<java.lang.String>? {
    ...
    @Throws(PreferenceSerializationException::class)
    override fun deserialize(value: java.util.Set<java.lang.String>?): java.util.HashMap<String, String>? {
