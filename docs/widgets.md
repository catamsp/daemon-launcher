...
&mu;Daemon launcher allows to add [app widgets](https://developer.android.com/develop/ui/views/appwidgets/overview) to the home screen and to widget panels.
...
However, &mu;Daemon launcher [gestures](/docs/actions-and-gestures/) can not be executed in areas where such a widget is present.
...
&mu;Daemon launcher's clock behaves similarly to an app widget and can be managed in the same way.[^1]
