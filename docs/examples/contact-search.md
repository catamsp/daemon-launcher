...
Probably your preinstalled contacts app already provides a search feature.
This might however require one or two additional clicks to navigate to the search.
[Key Mapper](#key-mapper) can serve as a workaround.
...
[Key Mapper](https://github.com/keymapperorg/KeyMapper) is a very versatile tool to automate all kinds of tasks.
Usually, these actions are triggered by certain key presses,
but you can also use a pinned shortcut as a trigger.
For example, this allows to automate the process of launching the contacts app and opening the search.

[^1]: See [this list](/docs/alternatives/) for an overview of other launchers.
