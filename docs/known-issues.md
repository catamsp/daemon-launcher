...
Before reporting a bug, please check whether it has already been filed in the [issue tracker](https://github.com/catamsp/launcher/issues).

I'll try to fix bug related to &mu;Daemon launcher, however some problems
are caused by Android itself (or a vendor's modified version of Android)
and can't be fixed on &mu;Daemon launcher's side.
...
See also the relevant [list of issues](https://github.com/catamsp/launcher/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22android%20issue%22) in the issue tracker.
...
See [#212](https://github.com/catamsp/launcher/issues/212) in the issue tracker.
